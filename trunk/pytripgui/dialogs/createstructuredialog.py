...
class CreateStructureDialog(wx.Dialog):
    ...
    def Init(self,parent):
        ...
        center = [voxelplan_image.dimx/2.0*voxelplan_image.pixel_size,voxelplan_image.dimy/2.0*voxelplan_image.pixel_size,voxelplan_image.dimz/2.0*voxelplan_image.slice_distance]
    ...
    def submit(self,evt):
        ...
        if voi_type == "panel_cube":
            ...
            voi = create_cylinder(self.parent.data.get_images().get_voxelplan(),name,[x,y,z],cylinder_radius,cylinder_depth)
