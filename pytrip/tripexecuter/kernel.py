...
class KernelModel(object):
    ...
    sis_path = ""  # if none, it will be autogenerated
    comment = ""  # arbitrary text
    name = ""  # name for identifying this kernel, ie.e "C12_3mmRiFi"
    ...
    def _print(self):
        ...
        out += "   Kernel '{:s}'\n".format(self.name)
        out += "----------------------------------------------------------------------------\n"
        out += "|  RiFi Name                         : {:s}\n".format(str(self.rifi.name))
        out += "|  RiFi Thickness [mm]               : {:s}\n".format(str(self.rifi_thickness))
        out += "|"
        ...
        out += "----------------------------------------------------------------------------\n"
        if self.projectile:
            out += self.projectile._print()  # TODO: maybe _print should not be marked private.
        else:
            out += "| No projectile set.\n"
        return out
