...
def main(args=sys.argv[1:]):
    ...
    parser.add_argument("rois",
                        nargs="?",
                        help="comma-seperated list for ROIs to be analyzed. If not set, print list.",
                        type=str,
                        default=None)
    ...
    parser.add_argument("-t",
                        ...
                        default=None)
    parser.add_argument("-l", "--legend", dest='legend', default=False, action='store_true', help="print legend box")
