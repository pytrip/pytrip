...
# ones.
extensions = [
    'sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.viewcode',
...
texinfo_documents = [
    (master_doc, 'pytrip98', 'pytrip98 Documentation', author, 'pytrip98', 'One line description of project.',
     'Miscellaneous'),
]
