...
# -*- coding: utf-8 -*-
#
# pytrip documentation build configuration file, created by
# sphinx-quickstart
#
...
extensions = [
    ...
    'sphinx.ext.todo', 'sphinx.ext.viewcode', 'sphinx.ext.inheritance_diagram',
    'sphinx.ext.coverage', 'sphinx.ext.graphviz', 'sphinx.ext.napoleon'
]
...
try:
    release = pkg_resources.get_distribution('pytrip98').version
except pkg_resources.DistributionNotFound:
    print('pytrip98 must be installed to build the documentation.')
...
latex_documents = [
    (master_doc, 'pytrip98.tex', 'pytrip98 Documentation', 'Author', 'manual'),
]
...
man_pages = [(master_doc, 'pytrip98', 'pytrip98 Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'pytrip98', 'pytrip98 Documentation', author, 'pytrip98',
...
def run_apidoc(_):
    ...
    subprocess.check_call([
        cmd_path, '--module-first', '--separate', '-o', output_path,
        module_path
    ])
